...
# mv ~/Star_Wars_Luke_T/star_wars/empire/death_star/millenium_falcon/* ~/Star_Wars_Luke_T/star_wars/empire/death_star
# 2. darth_vader has defeated obi_wan! Delete poor obi_wan.
# rm ~/Star_Wars_Luke_T/star_wars/empire/death_star/obi_wan.txt
...
# mv ~/Star_Wars_Luke_T/star_wars/empire/death_star/darth_vader.txt ~/Star_Wars_Luke_T/star_wars/empire
# 6. Thanks to his practice back home at Beggar’s Canyon, Luke blew up the death_star! Remove it from the galaxy!
# rm -rf ~/Star_Wars_Luke_T/star_wars/empire/death_star