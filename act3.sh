...
mv ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/millenium_falcon/luke_skywalker.txt obi_wan.txt princess_leia.txt han_solo.txt chewbacca.txt ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/
...
mv ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/chewbacca.txt han_solo.txt luke_skywalker.txt obi_wan.txt princess_leia.txt~/sei/deliverables/Star_Wars/star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/millenium_falcon ~/mv ~/sei/deliverables/Star_Wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/darth_vader ~/mv ~/sei/deliverables/Star_Wars/star_wars/empire
# 6. Thanks to his practice back home at Beggar’s Canyon, Luke blew up the death_star! Remove it from the galaxy!
"rm -rf death_star"

git add .
git commit -m "Finished Star Wars"
